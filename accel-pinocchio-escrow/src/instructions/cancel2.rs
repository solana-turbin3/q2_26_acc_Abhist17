...
pub fn process_cancel_instruction_v2(
    ...
    // Validate maker's ATA in a scope
    {
        let maker_ata_state =
            pinocchio_token::state::TokenAccount::from_account_view(&maker_ata)?;
